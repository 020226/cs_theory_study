...
### 09. IoC컨테이너를 통한 객체 생성 및 필드 주입과 생성자 주입
...
### 16. me.html 그리고 th:if 타임리프 문법 도입하여 랜더링
...
### 19. Spring Data JPA → 하이버네이트(JPA 구현체) → MariaDB Driver(JDBC 구현체) → MariaDB
...
### 20. member 엔티티 도입, JPA 적용하여 회원을 영속화
